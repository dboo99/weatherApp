$(document).ready(function(){
    var city = [];  //사용자가 클릭한 곳의 도시명을 순서대로 넣을 공간(사용자가 좌측부터 클릭한다는 보장을 살 수 없기 때문에)
    var myKey = "2b78a0fc4dd4956e076f246ac9065ba4";
    var state_icon = "";
    ...
    function w_info(){
        //배열 데이터의 개수와는 상관없이 날씨의 개별 박스를 모두 제거해라
        $("#weather ul").empty();

        //현재시점에서 배열의 개수만큼 다시 반복하여 생성해라(renewal - 갱신)
    ...
    $(".cities button").click(function(){
        var $city_txt = $(this).text();   //클릭한 곳의 텍스트를 저장한다.
        city.push($city_txt);
        console.log(city);
        // $(this).hide();
    ...
    $(".search").keypress(function(event){
        ...
        // console.log($keyCode);
        if($keyCode == 13){  //키코드 13(엔터)가 들어왔을 경우
            // console.log("엔터값 적용");
            search();
        }
...
//api.openweathermap.org/data/2.5/weather?q=London&appid=2b78a0fc4dd4956e076f246ac9065ba4
//2b78a0fc4dd4956e076f246ac9065ba4